# Contributing to Sauce Connect REST API client

**Thank you for your interest in Sauce Connect REST API client. Your contributions are highly welcome.**
...
In order to release a new Sauce Connect REST API go client version, do the following:
